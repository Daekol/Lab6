class SchedulesController < ApplicationController
  ...
  private
    ...
    def schedule_params
      params.require(:schedule).permit(:idmatches, :teams_idteams1, :teams_idteams2, :date, :tournament_place, :team1_points_earned, :teams2_points_earned, :tournaments_idtournaments)
    end
end
